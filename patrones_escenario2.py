...
####### Empieza 5 Diccionarios #######
    ...
    if diccionario_L is not None and diccionario_U is not None and diccionario_B is not None:        
        for L, U, U2, B, L2 in product(diccionario_L.keys(), diccionario_U.keys(), diccionario_U.keys(), diccionario_B.keys(), diccionario_L.keys()):
            patron_34 = r'^({})\s+(\d+)\s+({})\s+(\d+)\s+({})\s+({})\s+(.*)'.format(re.escape(L), re.escape(U), re.escape(U2), re.escape(B))
            componentes_34 = verificar_patron_escenario2(cadena, patron_34)
            if componentes_34 is not None:
                componentes_direccion_escenario2["TipoPredio"] = diccionario_L.get(componentes_34[0]), componentes_34[1]
                componentes_direccion_escenario2["Urbanizacion"] = diccionario_U.get(componentes_34[2]), componentes_34[3], diccionario_U.get(componentes_34[4]), diccionario_B.get(componentes_34[5]), componentes_34[6]
                componentes_direccion_escenario2["InputPattern"] = '#L|^|U|^|U|B|?'
                componentes_direccion_escenario2["LineaPatron"] = '875'
                componentes_direccion_escenario2["DireccionEjemplo"] = 'APARTAMENTO 102 URBANIZACION 29 CONDOMINIO BARRIO PELIGROSO'
...
####### Empieza 4 Diccionarios #######
    ...
    if diccionario_M is not None and diccionario_L is not None and diccionario_U is not None and diccionario_B is not None:
        for M, L, U, B in product(diccionario_M.keys(), diccionario_L.keys(), diccionario_U.keys(), diccionario_B.keys()):
            patron_22 = r'^({})\s+(.*)\s+({})\s+(.*)\s+({})\s+(.*)\s+({})'.format(re.escape(M), re.escape(L), re.escape(U), re.escape(B))
            componentes_22 = verificar_patron_escenario2(cadena, patron_22)
            if componentes_22 is not None:
                componentes_direccion_escenario2["Manzana"] = diccionario_M.get(componentes_22[0]), componentes_22[1]
                componentes_direccion_escenario2["TipoPredio"] = diccionario_L.get(componentes_22[2]), componentes_22[3]
                componentes_direccion_escenario2["Urbanizacion"] = diccionario_U.get(componentes_22[4]), componentes_22[5], diccionario_B.get(componentes_22[6])
                componentes_direccion_escenario2["InputPattern"] = 'M|&|L|&|U|?|B'
                componentes_direccion_escenario2["LineaPatron"] = '525'
                componentes_direccion_escenario2["DireccionEjemplo"] = 'VEREDA EL ROBLE ESTACION GASOLINA UNIDADRESIDENCIAL FORTALEZA CIUDADELA'
                return componentes_direccion_escenario2
                
        for L, U, U2, L2 in product(diccionario_L.keys(), diccionario_U.keys(), diccionario_U.keys(), diccionario_L.keys()):
            patron_35 = r'^({})\s+(\d+)\s+({})\s+(\d+)\s+({})\s+({})\s+(.*)\s+(\d+)'.format(re.escape(L), re.escape(U), re.escape(U2), re.escape(L2))
            componentes_35 = verificar_patron_escenario2(cadena, patron_35)
            if componentes_35 is not None:
                componentes_direccion_escenario2["TipoPredio"] = diccionario_L.get(componentes_35[0]), componentes_35[1]
                componentes_direccion_escenario2["Urbanizacion"] = diccionario_U.get(componentes_35[2]), componentes_35[3], diccionario_U.get(componentes_35[4]), diccionario_L.get(componentes_35[5]), componentes_35[6], componentes_35[7]
                componentes_direccion_escenario2["InputPattern"] = '#L|^|U|^|U|L|?|^'
                componentes_direccion_escenario2["LineaPatron"] = '901'
                componentes_direccion_escenario2["DireccionEjemplo"] = 'APARTAMENTO 102 URBANIZACION 29 CONDOMINIO ENTRADA COLORINES 2'
                return componentes_direccion_escenario2
                
            patron_36 = r'^({})\s+(\d+)\s+({})\s+(\d+)\s+({})\s+({})\s+(.*)'.format(re.escape(L), re.escape(U), re.escape(U2), re.escape(L2))
            componentes_36 = verificar_patron_escenario2(cadena, patron_36)
            if componentes_36 is not None:
                componentes_direccion_escenario2["TipoPredio"] = diccionario_L.get(componentes_36[0]), componentes_36[1]
                componentes_direccion_escenario2["Urbanizacion"] = diccionario_U.get(componentes_36[2]), componentes_36[3], diccionario_U.get(componentes_36[4]), diccionario_L.get(componentes_36[5]), componentes_36[6]
                componentes_direccion_escenario2["InputPattern"] = '#L|^|U|^|U|L|?'
                componentes_direccion_escenario2["LineaPatron"] = '930'
                componentes_direccion_escenario2["DireccionEjemplo"] = 'APARTAMENTO 102 URBANIZACION 29 CONDOMINIO ENTRADA COLORINES'
                return componentes_direccion_escenario2 
                
    if diccionario_B is not None and diccionario_U is not None and diccionario_M is not None and diccionario_L is not None:        
        for B, U, M, L in product(diccionario_B.keys(), diccionario_U.keys(), diccionario_M.keys(), diccionario_L.keys()):           
            patron_190 = r'^({})\s+([A-Z]+)\s+({})\s+([A-Z]+)\s+([A-Z]+)\s+({})\s+(\d+)\s+({})\s+(\d+)$'.format(re.escape(B), re.escape(U), re.escape(M), re.escape(L))
            componentes_190 = verificar_patron_escenario2(cadena, patron_190)
            if componentes_190 is not None:
                componentes_direccion_escenario2["Barrio"] = diccionario_B.get(componentes_190[0]), componentes_190[1]
                componentes_direccion_escenario2["Urbanizacion"] = diccionario_U.get(componentes_190[2]), componentes_190[3], componentes_190[4]
                componentes_direccion_escenario2["Manzana"] = diccionario_M.get(componentes_190[5]), componentes_190[6]
                componentes_direccion_escenario2["TipoPredio"] =  diccionario_L.get(componentes_190[7]), componentes_190[8]
                componentes_direccion_escenario2["InputPattern"] = 'B|+|U|+|+|M|^|L|^'
                componentes_direccion_escenario2["LineaPatron"] = '008'
                componentes_direccion_escenario2["DireccionEjemplo"] = 'BARRIO NORMANDIA CONJUNTO LOS LAGARTOS TORRE 2 APARTAMENTO 102'
                return componentes_direccion_escenario2 
    ...
    if diccionario_M is not None and diccionario_R is not None and diccionario_U is not None:
        for M, R, U, U2 in product(diccionario_M.keys(), diccionario_R.keys(), diccionario_U.keys(), diccionario_U.keys()):
            patron_15 = r'^({})\s+(.*)\s+({})\s+(.*)\s+({})\s+(.*)\s+({})\s+(.*)'.format(re.escape(M), re.escape(R), re.escape(U), re.escape(U2))
            componentes_15 = verificar_patron_escenario2(cadena, patron_15)
            if componentes_15 is not None:
                componentes_direccion_escenario2["Manzana"] = diccionario_M.get(componentes_15[0]), componentes_15[1]
                componentes_direccion_escenario2["Casa"] = diccionario_R.get(componentes_15[2]), componentes_15[3]
                componentes_direccion_escenario2["Urbanizacion"] = diccionario_U.get(componentes_15[4]), componentes_15[5], diccionario_U.get(componentes_15[6]), componentes_15[7]
                componentes_direccion_escenario2["InputPattern"] = 'M|&|R|&|U|*?|U|&'
                componentes_direccion_escenario2["LineaPatron"] = '262'
                componentes_direccion_escenario2["DireccionEjemplo"] = 'MANZANA CUADRADA CASA VERDE CONDOMINIO LOS ALMENDROS BLOQUE PERDIDO'
                return componentes_direccion_escenario2
                
        for M, R, U, M2 in product(diccionario_M.keys(), diccionario_R.keys(), diccionario_U.keys(), diccionario_M.keys()):
            patron_14 = r'^({})\s+(.*)\s+({})\s+(.*)\s+({})\s+(.*)\s+({})\s+(.*)'.format(re.escape(M), re.escape(R), re.escape(U), re.escape(M2))
            componentes_14 = verificar_patron_escenario2(cadena, patron_14)
            if componentes_14 is not None:
                componentes_direccion_escenario2["Manzana"] = diccionario_M.get(componentes_14[0]), componentes_14[1]
                componentes_direccion_escenario2["Casa"] = diccionario_R.get(componentes_14[2]), componentes_14[3]
                componentes_direccion_escenario2["Urbanizacion"] = diccionario_U.get(componentes_14[4]), componentes_14[5], diccionario_M.get(componentes_14[6]), componentes_14[7]
    ...
    if diccionario_M is not None and diccionario_R is not None and diccionario_L is not None:
        for M, R, L, M2 in product(diccionario_M.keys(), diccionario_R.keys(), diccionario_L.keys(), diccionario_M.keys()):
            patron_16 = r'^({})\s+(.*)\s+({})\s+(.*)\s+({})\s+(.*)\s+({})\s+(.*)'.format(re.escape(M), re.escape(R), re.escape(L), re.escape(M2))
            componentes_16 = verificar_patron_escenario2(cadena, patron_16)
            if componentes_16 is not None:
                componentes_direccion_escenario2["Manzana"] = diccionario_M.get(componentes_16[0]), componentes_16[1]
                componentes_direccion_escenario2["Casa"] = diccionario_R.get(componentes_16[2]), componentes_16[3]
                componentes_direccion_escenario2["Urbanizacion"] = diccionario_L.get(componentes_16[4]), componentes_16[5], diccionario_M.get(componentes_16[6]), componentes_16[7]
                componentes_direccion_escenario2["InputPattern"] = 'M|&|R|&|L|&|M|&'
                componentes_direccion_escenario2["LineaPatron"] = '291'
                componentes_direccion_escenario2["DireccionEjemplo"] = 'EDIFICIO QUINTA AVENIDA CASA 34 CONSULTORIO 302 KILOMETRO 100'
                return componentes_direccion_escenario2
...
####### Empieza 3 Diccionarios #######
    ...
    if diccionario_U is not None and diccionario_L is not None and diccionario_B is not None:
        for U, L, B in product(diccionario_U.keys(),diccionario_L.keys(),diccionario_B.keys()):
            ...
            if componentes_323 is not None:
                ...
                componentes_direccion_escenario2["DireccionEjemplo"] = 'CONJUNTO APARTAMENTO LOS LAGARTOS 53 BARRIO CASTILLA'
                return componentes_direccion_escenario2
        ...
        for U, U2, B in product(diccionario_U.keys(),diccionario_U.keys(),diccionario_B.keys()):                
            ...
            if componentes_65 is not None:
                componentes_direccion_escenario2["Urbanizacion"] = diccionario_U.get(componentes_65[0]), componentes_65[1], diccionario_U.get(componentes_65[2]), diccionario_B.get(componentes_65[3]), componentes_65[4]
        ...
        for L, U, B in product(diccionario_L.keys(), diccionario_U.keys(), diccionario_B.keys()):            
            ...
            if componentes_39 is not None:
                componentes_direccion_escenario2["TipoPredio"] = diccionario_L.get(componentes_39[0]), componentes_39[1]
                componentes_direccion_escenario2["Urbanizacion"] = diccionario_U.get(componentes_39[2]), diccionario_B.get(componentes_39[3]), componentes_39[4]
        ...
        for L, U, U2 in product(diccionario_L.keys(), diccionario_U.keys(), diccionario_U.keys()):
            ...
            if componentes_37 is not None:
                componentes_direccion_escenario2["TipoPredio"] = diccionario_L.get(componentes_37[0]), componentes_37[1]
                componentes_direccion_escenario2["Urbanizacion"] = diccionario_U.get(componentes_37[2]), componentes_37[3], diccionario_U.get(componentes_37[4]), componentes_37[5]
                componentes_direccion_escenario2["InputPattern"] = '#L|^|U|^|U|?'
                componentes_direccion_escenario2["LineaPatron"] = '956'
                componentes_direccion_escenario2["DireccionEjemplo"] = 'APARTAMENTO 102 URBANIZACION 29 CONDOMINIO COLORINES'
                return componentes_direccion_escenario2
        ...
        for L, U, L2 in product(diccionario_L.keys(), diccionario_U.keys(), diccionario_L.keys()):            
            ...
            if componentes_41 is not None:
                componentes_direccion_escenario2["TipoPredio"] = diccionario_L.get(componentes_41[0]), componentes_41[1]
                componentes_direccion_escenario2["Urbanizacion"] = diccionario_U.get(componentes_41[2]), diccionario_L.get(componentes_41[3]), componentes_41[4]
            ...
            if componentes_42 is not None:
                componentes_direccion_escenario2["TipoPredio"] = diccionario_L.get(componentes_42[0]), componentes_42[1]
                componentes_direccion_escenario2["Urbanizacion"] = diccionario_U.get(componentes_42[2]), diccionario_L.get(componentes_42[3]), componentes_42[4]
                componentes_direccion_escenario2["InputPattern"] = 'L|^|U|L|?'
        ...
        for U, L, L2 in product(diccionario_U.keys(), diccionario_L.keys(), diccionario_L.keys()):
            ...
            if componentes_40 is not None:                
                componentes_direccion_escenario2["Urbanizacion"] = diccionario_U.get(componentes_40[0]), diccionario_L.get(componentes_40[1]), componentes_40[2]
                componentes_direccion_escenario2["TipoPredio"] =  diccionario_L.get(componentes_40[3]), componentes_40[4]
    ...
    if diccionario_B is not None and diccionario_M is not None and diccionario_L is not None:
        for B, M, L in product(diccionario_B.keys(),diccionario_M.keys(),diccionario_L.keys()):
            patron_324 = r'^({})\s+([A-Z]+)\s+({})\s+(\d+)\s+({})\s+(\d+)'.format(re.escape(B),re.escape(M),re.escape(L))
            componentes_324 = verificar_patron_escenario2(cadena,patron_324)
            if componentes_324 is not None:
                componentes_direccion_escenario2["Barrio"] = diccionario_B.get(componentes_324[0]), componentes_324[1]
                componentes_direccion_escenario2["Manzana"] = diccionario_M.get(componentes_324[2]), componentes_324[3]
                componentes_direccion_escenario2["TipoPredio"] = diccionario_L.get(componentes_324[4]), componentes_324[5]
            ...
            patron_184 = r'^({})\s+([A-Z]+)\s+([A-Z]+)\s+([A-Z]+)\s+([A-Z]+)\s+({})\s+([A-Z]+)\s+([A-Z]+)\s+({})\s+(\d+)$'.format(re.escape(B),re.escape(M),re.escape(L))
            componentes_184 = verificar_patron_escenario2(cadena,patron_184)
            if componentes_184 is not None:
                componentes_direccion_escenario2["Barrio"] = diccionario_B.get(componentes_184[0]), componentes_184[1], componentes_184[2], componentes_184[3], componentes_184[4]
                componentes_direccion_escenario2["Manzana"] = diccionario_M.get(componentes_184[5]), componentes_184[6], componentes_184[7]
                componentes_direccion_escenario2["TipoPredio"] = diccionario_L.get(componentes_184[8]), componentes_184[9]
                componentes_direccion_escenario2["InputPattern"] = 'B|+|+|+|+|M|+|+|L|^'
                componentes_direccion_escenario2["LineaPatron"] = '001'
                componentes_direccion_escenario2["DireccionEjemplo"] = 'BARRIO FRANCISCO DE PAULA SANTANDER EDIFICIO CAMILO TORRES LOCAL 2'
                return componentes_direccion_escenario2
                       
            patron_185 = r'^({})\s+([A-Z]+)\s+([A-Z]+)\s+([A-Z]+)\s+({})\s+([A-Z]+)\s+([A-Z]+)\s+({})\s+(\d+)$'.format(re.escape(B),re.escape(M),re.escape(L))
            componentes_185 = verificar_patron_escenario2(cadena,patron_185)
            if componentes_185 is not None:
                componentes_direccion_escenario2["Barrio"] = diccionario_B.get(componentes_185[0]), componentes_185[1], componentes_185[2], componentes_185[3]
                componentes_direccion_escenario2["Manzana"] = diccionario_M.get(componentes_185[4]), componentes_185[5], componentes_185[6]
                componentes_direccion_escenario2["TipoPredio"] = diccionario_L.get(componentes_185[7]), componentes_185[8]
                componentes_direccion_escenario2["InputPattern"] = 'B|+|+|+|M|+|+|L|^'
                componentes_direccion_escenario2["LineaPatron"] = '004'
                componentes_direccion_escenario2["DireccionEjemplo"] = 'BARRIO FRANCISCO PAULA SANTANDER EDIFICIO CAMILO TORRES LOCAL 2'
                return componentes_direccion_escenario2
                
            patron_187 = r'^({})\s+([A-Z]+)\s+([A-Z]+)\s+([A-Z]+)\s+({})\s+([A-Z]+)\s+({})\s+(\d+)$'.format(re.escape(B),re.escape(M),re.escape(L))
            componentes_187 = verificar_patron_escenario2(cadena,patron_187)
            if componentes_187 is not None:
                componentes_direccion_escenario2["Barrio"] = diccionario_B.get(componentes_187[0]), componentes_187[1], componentes_187[2], componentes_187[3]
                componentes_direccion_escenario2["Manzana"] = diccionario_M.get(componentes_187[4]), componentes_187[5]
                componentes_direccion_escenario2["TipoPredio"] = diccionario_L.get(componentes_187[6]), componentes_187[7]
                componentes_direccion_escenario2["InputPattern"] = 'B|+|+|+|M|+|L|^'
                componentes_direccion_escenario2["LineaPatron"] = '005'
                componentes_direccion_escenario2["DireccionEjemplo"] = 'BARRIO FRANCISCO PAULA SANTANDER EDIFICIO CAMILO LOCAL 2'
                return componentes_direccion_escenario2
                
            patron_186 = r'^({})\s+([A-Z]+)\s+([A-Z]+)\s+([A-Z]+)\s+([A-Z]+)\s+({})\s+([A-Z]+)\s+({})\s+(\d+)$'.format(re.escape(B),re.escape(M),re.escape(L))
            componentes_186 = verificar_patron_escenario2(cadena,patron_186)
            if componentes_186 is not None:
                componentes_direccion_escenario2["Barrio"] = diccionario_B.get(componentes_186[0]), componentes_186[1], componentes_186[2], componentes_186[3], componentes_186[4]
                componentes_direccion_escenario2["Manzana"] = diccionario_M.get(componentes_186[5]), componentes_186[6]
                componentes_direccion_escenario2["TipoPredio"] = diccionario_L.get(componentes_186[7]), componentes_186[8]
                componentes_direccion_escenario2["InputPattern"] = 'B|+|+|+|+|M|+|L|^'
                componentes_direccion_escenario2["LineaPatron"] = '003'
                componentes_direccion_escenario2["DireccionEjemplo"] = 'BARRIO FRANCISCO DE PAULA SANTANDER EDIFICIO CAMILO LOCAL 20'
                return componentes_direccion_escenario2
                
            patron_188 = r'^({})\s+([A-Z]+)\s+([A-Z]+)\s+({})\s+([A-Z]+)\s+({})\s+(\d+)$'.format(re.escape(B),re.escape(M),re.escape(L))
            componentes_188 = verificar_patron_escenario2(cadena,patron_188)
            if componentes_188 is not None:
                componentes_direccion_escenario2["Barrio"] = diccionario_B.get(componentes_188[0]), componentes_188[1], componentes_188[2]
                componentes_direccion_escenario2["Manzana"] = diccionario_M.get(componentes_188[3]), componentes_188[4]
                componentes_direccion_escenario2["TipoPredio"] = diccionario_L.get(componentes_188[5]), componentes_188[6]
                componentes_direccion_escenario2["InputPattern"] = 'B|+|+|M|+|L|^'
                componentes_direccion_escenario2["LineaPatron"] = '006'
                componentes_direccion_escenario2["DireccionEjemplo"] = 'BARRIO FRANCISCO SANTANDER EDIFICIO TORRES LOCAL 20'
                return componentes_direccion_escenario2    

            patron_402 = r'^({})\s+([A-Z]+)\s+({})\s+({})\s+([A-Z]+)\s+([A-Z]+)'.format(re.escape(B),re.escape(M),re.escape(L))
        ...
        for L, M, L2 in product(diccionario_L.keys(), diccionario_M.keys(), diccionario_L.keys()):                
            ...
            if componentes_31 is not None:
                componentes_direccion_escenario2["TipoPredio"] = diccionario_L.get(componentes_31[0]), componentes_31[1], diccionario_L.get(componentes_31[4]), componentes_31[5]
                componentes_direccion_escenario2["Manzana"] = diccionario_M.get(componentes_31[2]), componentes_31[3]
                componentes_direccion_escenario2["InputPattern"] = 'L|^|M|^|L|?'
                componentes_direccion_escenario2["LineaPatron"] = '798'
                componentes_direccion_escenario2["DireccionEjemplo"] = 'APARTAMENTO 102 EDIFICIO 1 PORTERIA GIRASOLES NORTE'
                return componentes_direccion_escenario2
                
            patron_32 = r'^({})\s+(.*)\s+(\d+)\s+({})\s+(.*)\s+({})\s+(.*)'.format(re.escape(L), re.escape(M),re.escape(L2))
            componentes_32 = verificar_patron_escenario2(cadena, patron_32)
            if componentes_32 is not None:
                componentes_direccion_escenario2["TipoPredio"] = diccionario_L.get(componentes_32[0]), componentes_32[1], componentes_32[2], diccionario_L.get(componentes_32[5]), componentes_32[6]
                componentes_direccion_escenario2["Manzana"] = diccionario_M.get(componentes_32[3]), componentes_32[4]
                componentes_direccion_escenario2["InputPattern"] = 'L|?|^|M|*&|L|&'
                componentes_direccion_escenario2["LineaPatron"] = '821'
                componentes_direccion_escenario2["DireccionEjemplo"] = 'APARTAMENTO EXTERIOR 102 EDIFICIO 161 PORTERIA VERDE'
                return componentes_direccion_escenario2

            patron_33 = r'^({})\s+(\d+)\s+(.*)\s+({})\s+(.*)\s+({})\s+(.*)'.format(re.escape(L), re.escape(M),re.escape(L2))
            componentes_33 = verificar_patron_escenario2(cadena, patron_33)
            if componentes_33 is not None:
                componentes_direccion_escenario2["TipoPredio"] = diccionario_L.get(componentes_33[0]), componentes_33[1], componentes_33[2], diccionario_L.get(componentes_33[5]), componentes_33[6]
                componentes_direccion_escenario2["Manzana"] = diccionario_M.get(componentes_33[3]), componentes_33[4]
                componentes_direccion_escenario2["InputPattern"] = 'L|^|?|M|*&|L|&'
                componentes_direccion_escenario2["LineaPatron"] = '848'
                componentes_direccion_escenario2["DireccionEjemplo"] = 'APARTAMENTO 102 EXTERIOR EDIFICIO 161 PORTERIA VERDE'
                return componentes_direccion_escenario2  
            ...
            if componentes_45 is not None:
                componentes_direccion_escenario2["TipoPredio"] = diccionario_L.get(componentes_45[4]), componentes_45[5], diccionario_L.get(componentes_45[0]), componentes_45[1]
                componentes_direccion_escenario2["Manzana"] = diccionario_M.get(componentes_45[2]), componentes_45[3]
                componentes_direccion_escenario2["InputPattern"] = 'L|*?|M|*&|L|&'
        ...
        for M, L, M2 in product(diccionario_M.keys(), diccionario_L.keys(), diccionario_M.keys()):
            ...
            if componentes_17 is not None:
                componentes_direccion_escenario2["Manzana"] = diccionario_M.get(componentes_17[0]), componentes_17[1]
                componentes_direccion_escenario2["TipoPredio"] = diccionario_L.get(componentes_17[2]), componentes_17[3], diccionario_M.get(componentes_17[4]), componentes_17[5]
                componentes_direccion_escenario2["InputPattern"] = 'M|&|L|&|M|&'
                componentes_direccion_escenario2["LineaPatron"] = '366'
                componentes_direccion_escenario2["DireccionEjemplo"] = 'MANZANA RURAL APARTAMENTO LOS AGUACATES MANZANA AGUA LINDA'
                return componentes_direccion_escenario2       
        ...
        for M, B, M2 in product(diccionario_M.keys(), diccionario_B.keys(), diccionario_M.keys()):
            ...
            if componentes_20 is not None:
                componentes_direccion_escenario2["Manzana"] = diccionario_M.get(componentes_20[0]), diccionario_B.get(componentes_20[1]), componentes_20[2], diccionario_M.get(componentes_20[3]), componentes_20[4]
    ...
    if diccionario_M is not None and diccionario_R is not None:
        for M, R, M2 in product(diccionario_M.keys(),diccionario_R.keys(), diccionario_M.keys()):
            ...
            if componentes_18 is not None:
                componentes_direccion_escenario2["Manzana"] = diccionario_M.get(componentes_18[0]), componentes_18[1]
                componentes_direccion_escenario2["TipoPredio"] = diccionario_R.get(componentes_18[2]), componentes_18[3], diccionario_M.get(componentes_18[4]), componentes_18[5]
            ...
            patron_24 = r'^({})\s+(.*)\s+(.*)\s+({})\s+(.*)\s+({})\s+(.*)'.format(re.escape(M), re.escape(R), re.escape(M2))
            componentes_24 = verificar_patron_escenario2(cadena, patron_24)
            if componentes_24 is not None:
                componentes_direccion_escenario2["Manzana"] = diccionario_M.get(componentes_24[0]), componentes_24[1], componentes_24[2], diccionario_R.get(componentes_24[3]), componentes_24[4], diccionario_M.get(componentes_24[5]), componentes_24[6]
                componentes_direccion_escenario2["InputPattern"] = '#M|&|&|R|&|M|&'
            ...
            patron_25 = r'^({})\s+(.*)\s+({})\s+(.*)\s+(.*)\s+({})\s+(.*)'.format(re.escape(M), re.escape(R), re.escape(M2))
            componentes_25 = verificar_patron_escenario2(cadena, patron_25)
            if componentes_25 is not None:
                componentes_direccion_escenario2["Manzana"] = diccionario_M.get(componentes_25[0]), componentes_25[1], diccionario_R.get(componentes_25[2]), componentes_25[3], componentes_25[4], diccionario_M.get(componentes_25[5]), componentes_25[6]
                componentes_direccion_escenario2["InputPattern"] = '#M|&|R|&|?|M|&'
                componentes_direccion_escenario2["LineaPatron"] = '675'
                componentes_direccion_escenario2["DireccionEjemplo"] = 'MANZANA REDOMA CASA TERMINAL NORTE VEREDA CORMONARES'
                return componentes_direccion_escenario2
            ...
            if componentes_26 is not None:
                componentes_direccion_escenario2["Manzana"] = diccionario_M.get(componentes_26[0]), componentes_26[1], diccionario_R.get(componentes_26[2]), componentes_26[3], diccionario_M.get(componentes_26[4]), componentes_26[5]
                componentes_direccion_escenario2["InputPattern"] = '#M|&|R|&|M|&'
                componentes_direccion_escenario2["LineaPatron"] = '675'
    ...
    if diccionario_F is not None and diccionario_B is not None:
        for F, B, B2 in product(diccionario_F.keys(), diccionario_B.keys(), diccionario_B.keys()):
            ...
            if componentes_7 is not None:
                ...
                componentes_direccion_escenario2["Barrio"] = diccionario_B.get(componentes_7[2]), diccionario_B.get(componentes_7[3]), componentes_7[4]
    ...
    if diccionario_M is not None and diccionario_U is not None:
        for M, U, M2 in product(diccionario_M.keys(), diccionario_U.keys(), diccionario_M.keys()):
            ...
            if componentes_19 is not None:
                componentes_direccion_escenario2["Manzana"] = diccionario_M.get(componentes_19[0]), componentes_19[1], diccionario_M.get(componentes_19[4]), componentes_19[5]
                componentes_direccion_escenario2["Urbanizacion"] = diccionario_U.get(componentes_19[2]), componentes_19[3]
    ...
    if diccionario_U is not None and diccionario_M is not None:
        ...
        for M, U in product(diccionario_M.keys(),diccionario_U.keys()):             
            ...
            if componentes_23 is not None:
                componentes_direccion_escenario2["Manzana"] = diccionario_M.get(componentes_23[0]), componentes_23[1]
                componentes_direccion_escenario2["Urbanizacion"] = diccionario_U.get(componentes_23[2]), componentes_23[3], componentes_23[4]
    ...
    if diccionario_B is not None and diccionario_M is not None:
        for B, M in product(diccionario_B.keys(),diccionario_M.keys()):
            ...
            if componentes_189 is not None:
                componentes_direccion_escenario2["Barrio"] = diccionario_B.get(componentes_189[0]), componentes_189[1]
                componentes_direccion_escenario2["Manzana"] = diccionario_M.get(componentes_189[2]), componentes_189[3]
    ...
    if diccionario_L is not None and diccionario_U is not None:
        for L, U in product(diccionario_L.keys(),diccionario_U.keys()):
            ...
            if componentes_43 is not None:
                componentes_direccion_escenario2["TipoPredio"] = diccionario_L.get(componentes_43[0]), componentes_43[1]
                componentes_direccion_escenario2["Urbanizacion"] = diccionario_U.get(componentes_43[2]), componentes_43[3]
            ...
            if componentes_44 is not None:
                componentes_direccion_escenario2["TipoPredio"] = diccionario_L.get(componentes_44[0]), componentes_44[1]
                componentes_direccion_escenario2["Urbanizacion"] = diccionario_U.get(componentes_44[2]), componentes_44[3]
                componentes_direccion_escenario2["InputPattern"] = '#L|^|U|<'
            ...
            if componentes_38 is not None:
                componentes_direccion_escenario2["TipoPredio"] = diccionario_L.get(componentes_38[0]), componentes_38[1]
                componentes_direccion_escenario2["Urbanizacion"] = diccionario_U.get(componentes_38[2]), componentes_38[3], componentes_38[4]
                componentes_direccion_escenario2["InputPattern"] = 'L|^|U|^|*?'
                componentes_direccion_escenario2["LineaPatron"] = '979'
                componentes_direccion_escenario2["DireccionEjemplo"] = 'APARTAMENTO 102 URBANIZACION 29 COLORINES MORADOS'
                return componentes_direccion_escenario2 
    ...
    if diccionario_L is not None and diccionario_U is not None:
        for L, M in product(diccionario_L.keys(),diccionario_M.keys()):
            ...
            if componentes_181 is not None:
                componentes_direccion_escenario2["TipoPredio"] = diccionario_L.get(componentes_181[0]), componentes_181[1]
                componentes_direccion_escenario2["Manzana"] = diccionario_M.get(componentes_181[2]), componentes_181[3]
    ...
    if diccionario_M is not None and diccionario_L is not None:        
        for M, L in product(diccionario_M.keys(), diccionario_L.keys()):
            ...
            if componentes_70 is not None:
                componentes_direccion_escenario2["Manzana"] = diccionario_M.get(componentes_70[0]), componentes_70[1]
                componentes_direccion_escenario2["Urbanizacion"] = diccionario_L.get(componentes_70[2]), componentes_70[3]
        ...
        for M, M2 in product(diccionario_M.keys(), diccionario_M.keys()):
            ...
            if componentes_21 is not None:
                componentes_direccion_escenario2["Manzana"] = diccionario_M.get(componentes_21[0]), componentes_21[1], diccionario_M.get(componentes_21[2]), componentes_21[3]
    ...
    if diccionario_F is not None and diccionario_M is not None:
        for F, M in product(diccionario_F.keys(), diccionario_M.keys()):
            ...
            if componentes_56 is not None:
                componentes_direccion_escenario2["TipoPredio"] = diccionario_F.get(componentes_56[0]), componentes_56[1]
                componentes_direccion_escenario2["Manzana"] = diccionario_M.get(componentes_56[2]), componentes_56[3], componentes_56[4]
    ...
    if diccionario_L is not None and diccionario_C is not None:
        for L, C in product(diccionario_L.keys(), diccionario_C.keys()):
            ...
            if componentes_30 is not None:
                componentes_direccion_escenario2["TipoPredio"] = diccionario_L.get(componentes_30[0]), componentes_30[1]
                componentes_direccion_escenario2["TipoPiso"] = diccionario_C.get(componentes_30[2]), componentes_30[3]
        ...
        for L, L2 in product(diccionario_L.keys(), diccionario_L.keys()):
            ...
            if componentes_46 is not None:
                componentes_direccion_escenario2["TipoPredio"] = diccionario_L.get(componentes_46[0]), componentes_46[1], diccionario_L.get(componentes_46[2]), componentes_46[3]
            ...
            if componentes_47 is not None:
                componentes_direccion_escenario2["TipoPredio"] = diccionario_L.get(componentes_47[0]), componentes_47[1], diccionario_L.get(componentes_47[2]), componentes_47[3]
                componentes_direccion_escenario2["InputPattern"] = '#L|&|L|&'
    ...
    if diccionario_M is not None and diccionario_R is not None:
        for M, R in product(diccionario_M.keys(), diccionario_R.keys()):                
            ...
            if componentes_182 is not None:
                componentes_direccion_escenario2["Manzana"] = diccionario_M.get(componentes_182[0]), componentes_182[1]
                componentes_direccion_escenario2["Casa"] = diccionario_R.get(componentes_182[2]), componentes_182[3]
    ...
    if diccionario_M is not None:
        for M in diccionario_M.keys():
            ...
            if componentes_1 is not None:
                componentes_direccion_escenario2["Manzana"] = diccionario_M.get(componentes_1[0]), componentes_1[1]
            ...
            if componentes_27 is not None:
                componentes_direccion_escenario2["Manzana"] = diccionario_M.get(componentes_27[0]), componentes_27[1], componentes_27[2]
                componentes_direccion_escenario2["InputPattern"] = '#M|&|?'
            ...
            if componentes_61 is not None:
                componentes_direccion_escenario2["Manzana"] = diccionario_M.get(componentes_61[0]), componentes_61[1] + ' ' + componentes_61[2]
                componentes_direccion_escenario2["InputPattern"] = '#M|^|**'
            ...
            if componentes_63 is not None:
                componentes_direccion_escenario2["Manzana"] = diccionario_M.get(componentes_63[0]), componentes_63[1] + ' ' + componentes_63[2]
                componentes_direccion_escenario2["InputPattern"] = '#M|+|**'
            ...
            if componentes_64 is not None:
                componentes_direccion_escenario2["Manzana"] = diccionario_M.get(componentes_64[0]), componentes_64[1] + ' ' + componentes_64[2]
                componentes_direccion_escenario2["InputPattern"] = '#M|>|**'
            ...
            if componentes_62 is not None:
                componentes_direccion_escenario2["Manzana"] = diccionario_M.get(componentes_62[0]), componentes_62[1], componentes_62[2]
    ...
    if diccionario_R is not None:
        for R in diccionario_R.keys():
            ...
            if componentes_28 is not None:
                componentes_direccion_escenario2["Casa"] = diccionario_R.get(componentes_28[0]), componentes_28[1], componentes_28[2]
            ...
            if componentes_29 is not None:
                componentes_direccion_escenario2["Casa"] = diccionario_R.get(componentes_29[0]), componentes_29[1]
                componentes_direccion_escenario2["InputPattern"] = '#R|*&'
    ...
    if diccionario_U is not None:
        for U in diccionario_U.keys():
            ...
            if componentes_301 is not None:
                componentes_direccion_escenario2["NombreUrbanizacion"] = re.sub(r'\s+', ' ', f"{diccionario_U.get(componentes_301[0])} {componentes_301[1]}")
                componentes_direccion_escenario2["InputPattern"] = 'U|+'
            ...
            if componentes_325 is not None:
                componentes_direccion_escenario2["NombreUrbanizacion"] = re.sub(r'\s+', ' ', f"{diccionario_U.get(componentes_325[0])} {componentes_325[1]} {componentes_325[2]}")
                componentes_direccion_escenario2["InputPattern"] = 'U|+|+'
            ...
            if componentes_326 is not None:
                componentes_direccion_escenario2["NombreUrbanizacion"] = re.sub(r'\s+', ' ', f"{diccionario_U.get(componentes_326[0])} {componentes_326[1]} {componentes_326[2]}")
                componentes_direccion_escenario2["InputPattern"] = 'U|+|+|+'
    ...
    if diccionario_C is not None:                
        for C in diccionario_C.keys():
            ...
            if componentes_53 is not None:
                componentes_direccion_escenario2["TipoPiso"] = diccionario_C.get(componentes_53[0]), componentes_53[1], componentes_53[2]
            ...
            if componentes_54 is not None:
                componentes_direccion_escenario2["TipoPiso"] = diccionario_C.get(componentes_54[0]), componentes_54[1], componentes_54[2]
            ...
            if componentes_55 is not None:
                componentes_direccion_escenario2["TipoPiso"] = diccionario_C.get(componentes_55[0]), componentes_55[1], componentes_55[2]
                componentes_direccion_escenario2["InputPattern"] = '#C|>|**'
            ...
            if componentes_52 is not None:
                componentes_direccion_escenario2["TipoPiso"] = diccionario_C.get(componentes_52[0]), componentes_52[1], componentes_52[2]
                componentes_direccion_escenario2["InputPattern"] = '#C|^|**'
    ...
    if diccionario_L is not None:                
        for L in diccionario_L.keys():
            ...
            if componentes_48 is not None:
                componentes_direccion_escenario2["TipoPredio"] = diccionario_L.get(componentes_48[0]), componentes_48[1], componentes_48[2]
            ...
            if componentes_49 is not None:
                componentes_direccion_escenario2["TipoPredio"] = diccionario_L.get(componentes_49[0]), componentes_49[1], componentes_49[2]
                componentes_direccion_escenario2["InputPattern"] = '#L|^|?'
            ...
            if componentes_51 is not None:
                componentes_direccion_escenario2["TipoPredio"] = diccionario_L.get(componentes_51[0]), componentes_51[1], componentes_51[2]
                componentes_direccion_escenario2["InputPattern"] = '#L|>|**'
            ...
            if componentes_50 is not None:
                componentes_direccion_escenario2["TipoPredio"] = diccionario_L.get(componentes_50[0]), componentes_50[1]
                componentes_direccion_escenario2["InputPattern"] = '#L|^|**'
    ...
    if diccionario_F is not None:                
        for F in diccionario_F.keys():            
            ...
            if componentes_58 is not None:
                componentes_direccion_escenario2["TipoPredio"] = diccionario_F.get(componentes_58[0]), componentes_58[1] + ' ' + componentes_58[2]
            ...
            if componentes_57 is not None:
                componentes_direccion_escenario2["TipoPredio"] = diccionario_F.get(componentes_57[0]), componentes_57[1], componentes_57[2]
            ...
            if componentes_59 is not None:
                componentes_direccion_escenario2["TipoPredio"] = diccionario_F.get(componentes_59[0]), componentes_59[1] + ' ' + componentes_59[2]
                componentes_direccion_escenario2["InputPattern"] = '#F|+|**'
            ...
            if componentes_60 is not None:
                componentes_direccion_escenario2["TipoPredio"] = diccionario_F.get(componentes_60[0]), componentes_60[1] + ' ' + componentes_60[2]
                componentes_direccion_escenario2["InputPattern"] = '#F|>|**'
            ...
            if componentes_180 is not None:
                componentes_direccion_escenario2["TipoPredio"] = diccionario_F.get(componentes_180[0]), componentes_180[1]
                componentes_direccion_escenario2["InputPattern"] = 'F|^'
                componentes_direccion_escenario2["LineaPatron"] = '0'
    ...
    if diccionario_B is not None:
        for B in diccionario_B.keys():
            ...
            if componentes_304 is not None:
                componentes_direccion_escenario2["Barrio"] = diccionario_B.get(componentes_304[0]) + " " + componentes_304[1] + " " + componentes_304[2]
